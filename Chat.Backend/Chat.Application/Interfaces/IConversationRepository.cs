...
namespace Chat.Application.Interfaces
{
    public interface IConversationRepository
    {
        ...
        Task<IEnumerable<ConversationDTO>> GetByUserIdAsync(Guid userId, CancellationToken cancellationToken = default);
        ...
        Task<Result<ConversationDTO>> GetByIdForReciever(Guid conversationId, Guid currentUserId, CancellationToken cancellationToken);
    }
}
